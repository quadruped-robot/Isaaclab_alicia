...
All the environments are registered in the `Isaaclab_alicia` extension. They start
...
import Isaaclab_alicia.tasks  # noqa: F401


def main():
    """Print all environments registered in `Isaaclab_alicia` extension."""
